...
function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, $locationProvider, IdleProvider) {
    ...
    $stateProvider
        ...
        .state('maid.business',
            {
                url: "/business?page&empID&fromDate&toDate&apartment&building&address&projectId",
                templateUrl: "html/maidbusiness.html"
            })
        .state('maid.problem',
            {
                url: "/problem?page&search&type&fromDate&toDate&apartment&building&address&projectId",
